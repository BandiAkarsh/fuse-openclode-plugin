...
/home/akarsh/.config/opencode/context/development/
├── navigation.md
├── clean-code.md
├── react-patterns.md
└── api-design.md
...
mkdir -p /home/akarsh/.config/opencode/context/{category}
...
```bash
cat > /home/akarsh/.config/opencode/context/{category}/navigation.md << 'EOF'
...
```
/home/akarsh/.config/opencode/context/{category}/
...
Loads: `/home/akarsh/.config/opencode/context/ui/web/react-patterns.md`
